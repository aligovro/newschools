...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /*
        |--------------------------------------------------------------------------
        | blagoqr — БД внешнего сайта (WordPress) для парсинга
        |--------------------------------------------------------------------------
        | Используется только модулем blagoqr_import при импорте. Основное приложение
        | к этому подключению не обращается. Не настраивать в prod без необходимости.
        */
        'blagoqr' => [
            'driver' => 'mysql',
