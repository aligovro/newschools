...
class OrganizationPageController extends Controller
{
  ...
  {
    $this->authorize('viewAny', [OrganizationPage::class, $organization]);
  ...
  {
    $this->authorize('create', [OrganizationPage::class, $organization]);
   ...
   * Просмотр страницы
   */
  public function show(Organization $organization, OrganizationPage $page): View
  {
   ...
   */
  public function edit(Organization $organization, OrganizationPage $page): View
  {
   ...
   */
  public function duplicate(Organization $organization, OrganizationPage $page): RedirectResponse
  {
    $this->authorize('create', [OrganizationPage::class, $organization]);
   ...
   */
  public function updateStatus(Request $request, Organization $organization, OrganizationPage $page): RedirectResponse
  {
    $this->authorize('update', [$page, $organization]);
