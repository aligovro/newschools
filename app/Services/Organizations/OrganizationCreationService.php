...
class OrganizationCreationService
{
  ...
  private function assignAdminToOrganization(Organization $organization, User $adminUser): void
  {
    ...
    if (!$adminUser->hasRole('organization_admin')) {
      $adminUser->assignRole('organization_admin');
    }

    // Добавляем в organization_users
   ...
   */
  public function createOrganizationSite(Organization $organization, array $siteData): Site
  {
   ...
   */
  private function duplicateGalleryForSite(Organization $organization, Site $site): void
  {
   ...
   */
  private function createAutoPagesForSite(Organization $organization, Site $site): void
  {
    $autoPages = [
      [
        'title' => 'Спасибо',
