...
return new class extends Migration
{
  ...
  public function up(): void
  {
    Schema::table('organization_sites', function (Blueprint $table) {
      ...
      $table->foreign('domain_id')->references('id')->on('organization_domains')->onDelete('set null');
    });
  }
  ...
  public function down(): void
  {
    Schema::table('organization_sites', function (Blueprint $table) {
      ...
      // Добавляем внешний ключ обратно
      $table->foreign('domain_id')->references('id')->on('organization_domains')->onDelete('cascade');
    });
  }
};
