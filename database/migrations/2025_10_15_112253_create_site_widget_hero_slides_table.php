...
return new class extends Migration
{
  ...
  {
    Schema::create('site_widget_hero_slides', function (Blueprint $table) {
      $table->id();
      ...
      $table->index(['site_widget_id', 'slide_order'], 'idx_slide_order');
      $table->index('site_widget_id', 'idx_site_widget');
    });
  }
  ...
  {
    Schema::dropIfExists('site_widget_hero_slides');
  }
};
