...
class OrganizationPagesSeeder extends Seeder
{
  /**
  ...
  public function run(): void
  {
    ...
    $homepage = OrganizationPage::create([
    ...
    $aboutPage = OrganizationPage::create([
      'organization_id' => $organization->id,
      'title' => 'О нас',
      'slug' => 'about',
    ...
    $contactPage = OrganizationPage::create([
      'organization_id' => $organization->id,
      'title' => 'Контакты',
      'slug' => 'contact',
    ...
    $blogPage = OrganizationPage::create([
      'organization_id' => $organization->id,
      'title' => 'Блог',
      'slug' => 'blog',
    ...
    $blogPost1 = OrganizationPage::create([
      'organization_id' => $organization->id,
    ...
    $blogPost2 = OrganizationPage::create([
      'organization_id' => $organization->id,
    ...
    $landingPage = OrganizationPage::create([
      'organization_id' => $organization->id,
      'title' => 'Наши услуги',
      'slug' => 'services',
    ...
    $draftPage = OrganizationPage::create([
      'organization_id' => $organization->id,
    ...
    $this->command->info('Создано ' . OrganizationPage::count() . ' страниц для организации: ' . $organization->name);
  }
}
