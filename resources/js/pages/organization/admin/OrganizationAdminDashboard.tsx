...
export default function OrganizationAdminDashboard({
    ...
    const adminMenuItems = [
        {
            ...
            href: `/organization/${organization.id}/admin/console`,
            icon: BarChart3,
            color: 'bg-blue-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/settings`,
            icon: Settings,
            color: 'bg-green-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/payments`,
            icon: DollarSign,
            color: 'bg-yellow-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/homepage`,
            icon: Eye,
            color: 'bg-purple-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/telegram`,
            icon: Globe,
            color: 'bg-cyan-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/reports`,
            icon: BarChart3,
            color: 'bg-indigo-500',
        },
    ];
    ...
    const siteMenuItems = [
        ...
        },
        {
            ...
            href: `/organization/${organization.id}/admin/pages`,
            icon: Menu,
            color: 'bg-orange-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/menus`,
            icon: Menu,
            color: 'bg-pink-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/sliders`,
            icon: Eye,
            color: 'bg-teal-500',
        },
    ];
    ...
    const userMenuItems = [
        {
            ...
            href: `/organization/${organization.id}/admin/users`,
            icon: Users,
            color: 'bg-slate-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/gallery`,
            icon: Eye,
            color: 'bg-rose-500',
        },
        {
            ...
            href: `/organization/${organization.id}/admin/analytics`,
            icon: BarChart3,
            color: 'bg-violet-500',
        },
    ];
