...
import SeoSettings from '@/components/dashboard/settings/sites/SeoSettings';
import ThemeCustomizer from '@/components/dashboard/settings/sites/ThemeCustomizer';
