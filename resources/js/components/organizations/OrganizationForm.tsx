...
interface OrganizationFormProps {
    ...
    organizationSettings?: { payment_settings?: PaymentGatewaysSettingsValue };
}
                                    ...
                                    onChange={(value) => {
                                        ...
                                        const selectedRegion =
                                            organization?.region?.id ===
                                                value ||
                                            (
                                                referenceData?.regions as any[]
                                            )?.find((r: any) => r.id === value);
                                        if (
                                            ...
                                            if (!latitude || !longitude) {
                                                // Если координат еще нет, устанавливаем координаты региона
                                                setLatitude(
                                                    selectedRegion.latitude,
                                                );
                                                setLongitude(
                            ...
                            <div>
                                <UniversalSelect
                                    ...
                                    onChange={(value) => {
                                        ...
                                        const selectedCity =
                                            organization?.city?.id === value ||
                                            (
                                                referenceData?.cities as any[]
                                        ...
                                        if (
                                            ...
                                            if (!latitude || !longitude) {
                                                // Если координат еще нет, устанавливаем координаты города
                                                setLatitude(
                                                    selectedCity.latitude,
                                                );
                                                setLongitude(
