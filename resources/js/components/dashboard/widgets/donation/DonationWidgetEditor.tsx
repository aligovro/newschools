...
import { Heart, Settings, ChevronUp, ChevronDown } from 'lucide-react';
...
export const DonationWidgetEditor: React.FC<DonationWidgetEditorProps> = React.memo(
    ({ isSettingsExpanded, localConfig, onToggleSettings, renderPreview, setLocalConfig }) => {
        const {
            title,
            description,
                        ...
                        {isSettingsExpanded && (
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    <h4 className="text-sm font-semibold text-gray-700">Основное</h4>
                                    <div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    setLocalConfig((prev) => ({
                                                        ...prev,
                                                        default_amount: Number.parseInt(
                                                            e.target.value,
                                                            10,
                                                        ) || 100,
                                                    }))
                                        ...
                                        <div>
                                            <Label htmlFor="min_amount">Минимум</Label>
                                            <Input
                                                id="min_amount"
                                                type="number"
                                                value={min_amount}
                                        ...
                                        <div>
                                            <Label htmlFor="max_amount">Максимум (0 = нет)</Label>
                                            <Input
                                                id="max_amount"
                                                type="number"
                                                value={max_amount}
                                ...
                                <div className="space-y-3">
                                    <h4 className="text-sm font-semibold text-gray-700">Опции</h4>
                                    <div className="flex items-center space-x-2">
                                        <Checkbox
                                            ...
                                            onCheckedChange={(checked) =>
                                                setLocalConfig((prev) => ({
                                                    ...prev,
                                                    allow_recurring: checked as boolean,
                                                }))
                                            }
                                        />
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <Checkbox
                                            ...
                                            onCheckedChange={(checked) =>
                                                setLocalConfig((prev) => ({
                                                    ...prev,
                                                    show_progress: checked as boolean,
                                                }))
                                            }
                                        />
                                        <Label htmlFor="show_progress">Показывать прогресс сбора</Label>
                                    </div>
                                </div>
                            </div>
                        )}
