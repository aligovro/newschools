...
interface RegionRatingWidgetConfig {
    title?: string;
    subtitle?: string;
...
interface RegionRatingWidgetProps {
    config?: RegionRatingWidgetConfig;
    isEditable?: boolean;
...
export const RegionRatingWidget: React.FC<RegionRatingWidgetProps> = ({
    config = {},
    isEditable = false,
    ...
    const [localConfig, setLocalConfig] =
        useState<RegionRatingWidgetConfig>(config);
    ...
    useEffect(() => {
        ...
        setSortBy(config.sort_by || 'amount');
    ...
    if (isEditable) {
        return (
            <div className="region-rating-widget-editor w-full">
    ...
    return (
        <div
            className={`region-rating-widget ${borderRadiusClass} ${shadowClass} border bg-white`}
        >
            <div className="p-6">
                {/* Заголовок */}
