...
return [
    ...
    'password'             => [
        ...
        'uncompromised' => 'Указанный :attribute присутствует в утечке данных. Пожалуйста, выберите другой :attribute.',
    ],
    ...
    'custom' => [
        'slug' => [
            'unique' => 'Страница с таким URL уже существует на этом сайте.',
            'regex'  => 'URL может содержать только строчные латинские буквы, цифры и дефисы.',
        ],
    ],
